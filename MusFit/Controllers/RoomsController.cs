...
namespace MusFit.Controllers
{
    ...
    public class RoomsController : ControllerBase
    {
		...
		#region 只比較日期
		// GET: api/Rooms/date/2023-01-01/2023-02-01
		[HttpGet("date/{dateStart}/{dateEnd}")]
		public async Task<ActionResult<IEnumerable<dynamic>>> GetRoomQuery1(string dateStart, string dateEnd)
		{
			var date_start = Convert.ToDateTime(dateStart);
			var date_end = Convert.ToDateTime(dateEnd);
		...
		#region 比較日期 + 時段
		// GET: api/Rooms/date/2023-01-01/2023-02-01/9
		[HttpGet("date/{dateStart}/{dateEnd}/{tID}")]
		public async Task<ActionResult<IEnumerable<dynamic>>> GetRoomQuery2(string dateStart, string dateEnd, int tID)
		{
			var date_start = Convert.ToDateTime(dateStart);
			var date_end = Convert.ToDateTime(dateEnd);
		...
		#region 比較日期 + 教室
		// GET: api/Rooms/dateRoom/2023-01-01/2023-02-01/5
		[HttpGet("dateRoom/{dateStart}/{dateEnd}/{roomID}")]
		public async Task<ActionResult<IEnumerable<dynamic>>> GetRoomQuery3(string dateStart, string dateEnd, int roomID)
		{
			var date_start = Convert.ToDateTime(dateStart);
			var date_end = Convert.ToDateTime(dateEnd);
		...
		#region 比較日期 + 時段 +教室
		// GET: api/Rooms/date/2023-01-01/2023-02-01/9/5
		[HttpGet("date/{dateStart}/{dateEnd}/{tID}/{roomID}")]
		public async Task<ActionResult<IEnumerable<dynamic>>> GetRoomQuery4(string dateStart, string dateEnd, int tID, int roomID)
		{
			var date_start = Convert.ToDateTime(dateStart);
			var date_end = Convert.ToDateTime(dateEnd);
